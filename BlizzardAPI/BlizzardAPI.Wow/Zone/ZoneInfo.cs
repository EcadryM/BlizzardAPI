...
namespace BlizzardAPI.Wow.Zone
{
    public class ZoneInfo
    {
        ...
        public List<Boss.BossFields> Bosses { get => bosses; set => bosses = value; }

        private List<Boss.BossFields> bosses = new List<Boss.BossFields>();

        public ZoneInfo(string zoneID, string region, string locale)
        {
            ...
            Bosses = zoneData["bosses"].ToObject<List<Boss.BossFields>>();
        }
    }
}
